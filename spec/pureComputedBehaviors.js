...
describe('Pure Computed', function() {
    ...
    describe('Should maintain order of subscriptions', function () {
        ...
        // NOTE: When using deferred updates, the order doesn't seem to matter; this may require some further analysis

        xit('base behavior: order is pure computed, observable', function() {
        ...
        xit('base behavior: order is observable, pure computed', function() {
        ...
        xit('when awakening, without re-evaluation', function() {
            var timesEvaluated = 0,
