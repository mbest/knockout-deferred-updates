(function() {
    ...
    // By default, we run the tests against knockout-3.3.0.js, but you can specify an alternative test
    // subject as a querystring parameter, e.g., runner.html?src=spec/lib/knockout-3.2.0.debug.js.
    // This is used by our automated test runners (PhantomJS and Testling CI).
    var koFilename = getParam('src') || "spec/lib/knockout-3.3.0.js";
