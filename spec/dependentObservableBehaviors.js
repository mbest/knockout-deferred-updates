...
describe('Dependent Observable', {
    ...
    'Should invoke the read function (and trigger notifications) if the write function updates dependent observables': function() {
        ...
        // Initially undefined
        value_of(computed()).should_be(undefined);
        ...
        value_of(notifiedValue).should_be("new value");
    },
    ...
    'Should not subscribe to observables accessed through change notifications of an accessed computed': function() {
        ...
        value_of(computedInner.getDependencies().length).should_be(1);
        value_of(computedOuter.getDependencies().length).should_be(1);
    },
